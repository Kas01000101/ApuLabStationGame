...
for (const token of [
  ...
  'data-command="analyzeSample"','data-testid="block-analyze-sample"','ANALIZAR MUESTRA','data-command="send"','ENVIAR DATOS','MUESTRA DESCONOCIDA','PUNTO DE COMUNICACIÓN',
  'TEMPERATURA','PROXIMIDAD','ANALIZADOR DE MATERIALES','CAMBIAR INSTRUMENTO','−58 °C','0.4 m','HIERRO','SILICATOS','FINALIZAR MISIÓN','level_completed','communication_point_reached','data_sent',
...
for (const token of [
  ...
  'data-command="read"','data-command="record"','EQUIPA UN SENSOR','EQUIPAR SENSOR','RANURA DE SENSOR','CAMBIAR SENSOR',
  'SENSOR DE TEMPERATURA','SENSOR DE PROXIMIDAD','ANALIZADOR DE MINERALES','ESPECTRÓMETRO','id="guide-btn"','PUNTO FINAL','final_point_reached','isAdjacentToSample',
...
if (!l7.includes("if(!relevantInstrumentUsed||!communicationPointReached||!dataSent||!atFinalCheckpoint())return")) fail('final_completion_gate_missing');
...
console.info('[mission01] LEVEL 7 FINAL SHELL OK · N6 continuity · fixed guide · exact sample + communication/send · REPETIR optional');
