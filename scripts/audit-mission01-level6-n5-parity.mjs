...
for (const token of [
  ...
  'Escaneo completado · Análisis completado · Datos enviados',
...
if (!l6.includes("if(!usesRepeat())")) fail('repeat_not_required');
if (!l6.includes("if(!scienceScanned||!scienceAnalyzed||!scienceSent)")) fail('science_cycle_not_required');

console.info('[mission01] LEVEL 6 ↔ N5 PARITY OK · 1672×941 · mismo shell/tablero/AYNI/editor 01–30 · ciencia añadida');
