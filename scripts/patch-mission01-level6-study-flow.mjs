...
for (const token of [
  ...
  "premature_action",
  "data_sent",
  "function openJournal(){document.getElementById('info-panel')?.classList.remove('visible')",
  "function completeLevel(){document.getElementById('info-panel')?.classList.remove('visible')",
