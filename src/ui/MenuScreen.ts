...
export class MenuScreen {
  ...
  constructor(private readonly root: HTMLElement, callbacks: MenuCallbacks) {
    ...
    this.element.innerHTML = `<div class="menu-actions"><button data-action="start" class="btn primary">INICIAR MISIÓN</button><button data-action="settings" class="btn">AJUSTES</button><button data-action="credits" class="btn">CRÉDITOS</button></div>`;
  ...
  setVisible(value: boolean): void { this.element.classList.toggle('hidden', !value); }
}
